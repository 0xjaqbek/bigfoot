...
export const translations = {
  ...
  step2Description: "Użyj swojego portfela kryptowalut aby wysłać wybraną kwotę na adres fundacji. Użyj Kalkulatora Kwot by uzyskać dokładną wartość w kryptowalucie. Zapisz link transakcji.",
  step3Title: "Wypełnij formularz potwierdzenia",
  step3Description: "Podaj dane osobowe, link do transakcji i informacje kontaktowe aby otrzymać nagrody i dostęp do grupy. Użyj Kalkulatora Kwot by wypełnić formularz. Wyślij formularz.",
  ...
  de: {
    ...
    copied: "Kopiert!",
    donationDetails: "Spendenformular",
  ...
  sv: {
    ...
    copied: "Kopierat!",
    donationDetails: "Donationsformulär",
  ...
  no: {
    ...
    copied: "Kopiert!",
    donationDetails: "Donasjonsskjema",
  ...
  da: {
    ...
    copyAddress: "Kopier adresse",
    copied: "Kopieret!",
    donationDetails: "Doneringsformular",
    donationInfo: "Donationsinformation",
    amount: "Beløb",
    blockchain: "Blockchain",
    transactionLink: "Transaktionslink",
